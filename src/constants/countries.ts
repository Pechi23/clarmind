// ISO 3166-1 country list for the birth-country picker. Codes let us bias the
// city autocomplete (Nominatim `countrycodes=`) to the chosen country. The flag
// emoji is derived from the 2-letter code (regional indicator letters), so we
// don't hand-maintain 200 emoji.
...
/** Turn an alpha-2 code into its flag emoji, e.g. "ro" → 🇷🇴. */
...
/** Find a country by (case-insensitive) name. */
