...
export const fr: TranslationShape = {
  ...
  leaderboard: {
    sampleNote: 'Joueurs d\'exemple, en attendant que d\'autres nous rejoignent.',
    kicker: 'CLASSEMENT',
  ...
  paywall: {
    ...
    legalNote: 'Renouvellement automatique jusqu\'à annulation dans le store. Annulez quand vous voulez.',
